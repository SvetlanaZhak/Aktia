...
export async function handleGetCustomers(_r: Request, _rt: ResponseToolkit): Promise<Customer[]> {
  const customers = await CustomerModel.findAll();
  return customers;
}

export async function handleGetCustomer(request: Request, _rt: ResponseToolkit): Promise<Customer> {
